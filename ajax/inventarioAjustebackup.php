                                ...
                                <div class="modal-body">
                                                  <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                      <label class=" input-sm">Seleccione Deposito:</label>
                                                        <select id="depositoD1" name="depositoD1" class="form-control input-sm selectpicker" data-live-search="true" ></select>
                                                    </div>
...
require 'footer.php';
?>
<script type="text/javascript" src="scripts/inventarioAjuste.js"></script>

...
Class InventarioAjuste
{
	...
	public function listar($Deposito_idDeposito, $fi, $ff, $estado, $Sucursal_idSucursal, $Categoria_idCategoria)
	{
		...
		/*$sql="CALL SP_ListarInventarioAjuste('$Deposito_idDeposito', '$fi', '$ff', '$estado', '$Sucursal_idSucursal', '$Categoria_idCategoria')";
		return ejecutarConsulta($sql);
		...
		*/ 
		$sql="SELECT a.idAjusteStock,b.descripcion as deposito,c.nombre as sucursal,d.nombre as categoria, a.fechaTransaccion,a.cantidadTotal,a.inactivo, Habilitacion_idHabilitacion
					 from ajusteStock a left outer join deposito b on a.Deposito_idDeposito=b.idDeposito 
	...
	public function mostrarDetalle($idInventarioAjuste)
	{
			...
			$sql="CALL SP_ListarInventarioAjusteDetalleApp('$idInventarioAjuste')";
	...
	public function mostrarDetalleArqueoAjuste($idHabilitacion)
	{

		 
			$sql="CALL SP_ListarInventarioAjusteDetalleAppArqueo('$idHabilitacion')";

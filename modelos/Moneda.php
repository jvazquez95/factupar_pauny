...
Class Moneda
{
	...
	//Implementar un método para listar los registros
	public function listarDenominacion($idMoneda)
	{ 
		$sql="SELECT b.idDetalleMoneda,a.idMoneda as idMoneda,b.idDetalleMoneda as idDetalle,a.descripcion moneda,b.descripcion as denominacion
				from moneda a, detallemoneda b 
				where a.idMoneda=b.Moneda_idMoneda and a.inactivo=0 and b.inactivo=0 and a.idMoneda='$idMoneda'";
		return ejecutarConsulta($sql);		
	}


	//Implementar un método para listar los registros
	public function mostrarDetalleMoneda($idMoneda)
	{
		 
		$sql="SELECT a.idMoneda as idMoneda,b.idDetalleMoneda as idDetalle,a.descripcion moneda,b.descripcion as denominacion
				from moneda a, detallemoneda b 
				where a.idMoneda=b.Moneda_idMoneda and a.inactivo=0 and b.inactivo=0 and a.idMoneda='$idMoneda'";
		return ejecutarConsulta($sql);		
	}

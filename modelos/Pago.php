...
Class Pago
{
	...
	public function listar($HABILITACION_IDHABILITACION)
	{
		...
		$sql="SELECT F_ESTADO_PAGO_FACTURAS(IDPAGO) AS INACTIVO, idPago, HABILITACION_IDHABILITACION, FECHAPAGO, persona.razonSocial as nc, USUARIO, TOTAL, pago.inactivo as pci from pago,persona where pago.PROVEEDOR_IDPROVEEDOR = persona.idPersona LIMIT 1000
		;";
		return ejecutarConsulta($sql);		
	}

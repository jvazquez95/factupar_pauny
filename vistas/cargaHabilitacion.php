              ...
              <div class="col-md-12">
                  <div class="box">
                    <div class="box-header with-border">
                          <h1 class="box-title">Habilitacion. </h1>
                    ...
                    <p class="text-monospace">Pendientes de Facturacion</p>
                    ...
                    <p class="text-monospace">Facturados</p>
                        ...
                        <form name="formulario" id="formulario" method="POST">
                          ...
                          <div class="form-group col-lg-3 col-md-2 col-sm-2 col-xs-12">
                            ...
                            <input type="hidden" class="form-control" name="Empleado_idEmpleado" id="Empleado_idEmpleado" value="<?php echo $_SESSION['login'] ?>"> 
                          ...
                          <!--  <select  title="Selecciona Persona" onchange="noCambiar(this);" class="selectpicker selector_persona form-control person" data-style="btn-warning" name="Cliente_idCliente" id="Cliente_idCliente"  data-live-search="true"></select>
                            <input type="hidden" class="form-control" name="articuloId" id="articuloId" >  
                          </div> -->
   						 
                           
                            <label>Usuario:</label>
                            <select id="Persona_idPersona" name="Persona_idPersona" onchange="noCambiar(this)" class="form-control selectpicker" data-live-search="true" required></select>
                          </div>
                          ...
                          <div class="form-group col-lg-3 col-md-2 col-sm-2 col-xs-12">
                            <label>Moneda(*):</label>
                            <!-- <select onchange="selectPeriodo(this)" name="CtaCte" id="CtaCte" class="form-control selectpicker" required="">
                            </select> --> 
                            <select   title="Selecciona CtaCte" onchange="addArticuloSaldo()"  class="selectpicker selector_ctacte form-control ctacte" name="CtaCte" id="CtaCte"  data-live-search="true" required></select>  
                          ...
                          <div class="form-group col-lg-1 col-md-2 col-sm-2 col-xs-12">
                            ...
                            <select name="periodo" id="periodo" onchange="addArticuloSaldo()" class="form-control selectpicker" required="">
                            </select>
                          </div>-->
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
                <div class="form-group col-lg-3 col-md-3 col-sm-4 col-xs-12">
                        <label>Buscar articulo:</label>
                        <input type="text" onblur="listarArticulos2();" class="form-control" name="buscar_art" id="buscar_art" >
...
$(document).ready(function(){
  $('select.selector_persona').selectpicker();
   ...
   var esto = this; 
    $.ajax({
    type: "POST",
    url: "../ajax/persona.php?op=selectUsuario",
...
<script type="text/javascript" src="scripts/cargaHabilitacion.js"></script>
<?php 
}
ob_end_flush();
?>

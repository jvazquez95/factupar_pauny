              ...
              <div class="col-md-12">
                  <div class="box">
                    <div class="box-header with-border">
                          <h1 class="box-title">Empleado <button class="btn btn-success" id="btnagregar" onclick="mostrarform(true)"><i class="fa fa-plus-circle"></i> Agregar</button></h1>
                    ...
                    <div class="panel-body" style="height: 400px;" id="formularioregistros">
                        <form name="formulario" id="formulario" method="POST">
                          ...
                          <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            ...
                            <input type="text" class="form-control" name="nombreComercial" id="nombreComercial" maxlength="250" placeholder="Nombre comercial">
                          </div>
                          ...
                          <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            ...
                            <input type="date" class="form-control" name="nacimiento" id="nacimiento" maxlength="20" placeholder="Documento">
                          </div>
                          ...
                          <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                           ...
                           <select class="form-control select-picker" name="idCategoriaCliente" id="idCategoriaCliente" data-live-search="true" required>
                            </select>
                          </div>
                          ...
                          <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <label>Termino de pago habilitado:</label>
                            <input type="text" class="form-control" name="terminoPagoHabilitado" id="terminoPagoHabilitado" maxlength="20" placeholder="Termno de pago habilitado">
                          </div>

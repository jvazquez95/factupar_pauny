              ...
              <div class="col-md-12">
                  <div class="box">
                    <div class="box-header with-border">
                          <h1 class="box-title">Pago <button class="btn btn-success"  id="btnagregar" onclick="mostrarform(true)"><i class="fa fa-plus-circle"></i> Agregar</button></h1>
                    ...
                    <div class="panel-body" style="height: 400px;" id="formularioregistros">                      
                        ...
                        <div class="form-group col-lg-2 col-md-2 col-sm-2 col-xs-12">
                          ...
                          <div class="form-group col-lg-3 col-md-3 col-sm-3 col-xs-12">
                            ...
                            <input type="hidden" class="form-control" name="ChequePropio_idChequePropio" id="ChequePropio_idChequePropio" required="">
                          </div>
          ...
          <h4 class="modal-title">Registrar nuevo cheque</h4>
                ...
                <div class="modal-body" id="formularioregistros">
                        <form name="formularioCheque" id="formularioCheque" method="POST">
                          ...
                          <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <label>Monto:</label>
                            <input type="text" class="form-control" name="montoCh" id="montoCh" placeholder="Monto" required>
                          </div>

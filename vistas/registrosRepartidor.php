              ...
              <div class="col-md-12">
                  <div class="box">
                    ...
                    <div class="box-header with-border">
                          <h1 class="box-title">Lista de Registros por Repartidor - Vendedor</h1>
                    ...
                    <div class="panel-body table-responsive" id="listadoregistros">
                        <table id="tbllistado" class="table table-striped table-bordered table-condensed table-hover">
                            <thead>
                              <th>Vendedor</th>
                              <th>Cantidad Registrada - Total</th>
                              <th>Cantidad Registrada - Hoy</th>
                          </thead>
                            <tbody>       
                            </tbody>
                            <tfoot>
...
<script type="text/javascript" src="scripts/registrosRepartidor.js"></script>
<?php 
}
ob_end_flush();
?>
                  ...
                  <div class="box">
                    ...
                    <div class="panel-body" style="height: 400px;" id="formularioregistros">
                        <form name="formulario" id="formulario" method="POST">
                          ...
                          <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <label>Origen:</label>
                            <input type="text" class="form-control" name="origen" id="origen" maxlength="50" placeholder="origen" required>
                          </div>
                          <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <label>Tipo de Marca:</label>
                            <select id="tipoMarca" name="tipoMarca" class="form-control input-sm selectpicker"  data-live-search="true" required>  

              ...
              <div class="col-md-12">
                  <div class="box">
                    <div class="box-header with-border">
                          <h1 class="box-title">Banco <button class="btn btn-success" id="btnagregar" onclick="mostrarform(true)"><i class="fa fa-plus-circle"></i> Agregar</button></h1>
                    ...
                    <div class="panel-body" style="height: 400px;" id="formularioregistros">
                        <form name="formulario" id="formulario" method="POST">
                         ...
                         <div class="form-group col-lg-2 col-md-2 col-sm-6 col-xs-12">
                            ...
                            <input type="text" class="form-control" name="nroCuenta" id="nroCuenta" maxlength="50" placeholder="Nro de Cuenta" required></input>
                          </div> 
                         <div class="form-group col-lg-2 col-md-2 col-sm-6 col-xs-12">    
                            <label>Tipo de Cuenta:</label>                    
                            <input type="text" class="form-control" name="tipoCuenta" id="tipoCuenta" maxlength="1" placeholder="Tipo de Cuenta" required></input>   
                          </div>                                                 

              ...
              <div class="col-md-12">
                  <div class="box">
                    <div class="box-header with-border">
                          <h1 class="box-title">Hechauka - Compras</h1>
                    ...
                    <div class="panel-body table-responsive" id="listadoregistros">
                            ...
                            <thead>
                              <th>1</th>
                              <th><?php $month = date('m')-1; $year = date('Y'); $day = date("d", mktime(0,0,0, $month, 0, $year)); echo date('Ym', mktime(0,0,0, $month, $day, $year)); ?></th>
                              <th>1</th>
                              <th>911</th>
                              <th>211</th>
                              <th>80028600</th>
...
<script type="text/javascript" src="scripts/hechaukaCompras.js"></script>
<?php 
}
ob_end_flush();
?>
              ...
              <div class="col-md-12">
                  <div class="box">
                    <div class="box-header with-border">
                          <h1 class="box-title">Cuentas a pagar </h1>
                    ...
                    <div class="panel-body table-responsive" id="listadoregistros">
                        ...
                        <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                          <label>Proveedor</label>
                              <select id="proveedor" name="proveedor" class="form-control selectpicker" data-live-search="true" required></select>
                        </div>
						<div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
...
require 'footer.php';
?>
<script type="text/javascript" src="scripts/cuentasAPagar.js"></script>
<?php 
}
ob_end_flush();
?>

...
<!--                           <div class="form-group col-lg-1 col-md-1 col-sm-1 col-xs-12">
                        ...
                        <div style="background-color: grey" class="col-lg-7 col-md-7 col-sm-7 col-xs-7">
                          ...
                          <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            ...
                            <input type="hidden" class="form-control" name="valorMoneda" id="valorMoneda" disabled>
                            <input type="hidden" class="form-control" name="valorMonedaN" id="valorMonedaN" disabled>
                      ...
                      <div id="ocultarInputs">
                          ...
                          <div class="form-group col-lg-1 col-md-1 col-sm-1 col-xs-12">
                            ...
                            <input type="hidden" class="form-control" name="valorTasa" id="valorTasa" disabled> 
                     ...
                     <div id="pagar">
                        ...
                        <div style="border:1px solid black;" class="col-lg-12 col-sm-12 col-md-12 col-xs-12 table-responsive">
                          ...
                          <div class="col-lg-12 col-sm-12 col-md-12 col-xs-12 table-responsive">
                            ...
                            <table id="detalles12" class="table table-striped table-bordered table-condensed table-hover">
                              <thead style="background-color:#A9D0F5">
                                <th>Opciones</th>
                                <th>Tipo de Pago</th>
                                <th>Moneda</th>
                              ...
                              <tfoot>
                                <tr>
                                  ...
                                  <th></th>
                                  <th>Total</th>
                                  <th><h4 id="total_detalle12"></h4><input type="hidden" name="t_detalle12" id="t_detalle12"></th>
                                  <th></th>
                                </tr>
                                <tr>
                                  <th></th>
                                  ...
                                  <th></th>
                                  <th>Vuelto</th>
                                  <th><h4 id="totalVuelto_detalle12"></h4><input type="hidden" name="tv_detalle12" id="tv_detalle12"></th>  
                                  <th></th>
                                </tr>
                              </tfoot>
                              <tbody>

                    ...
                    <div class="panel-body" style="height: 400px;" id="formularioregistros">
                        <form name="formulario" id="formulario" method="POST">
                          ...
                          <div class="form-group col-lg-2 col-md-2 col-sm-2 col-xs-2">
                            ...
                            <input type="text" class="form-control" name="habilitacion1" id="habilitacion1" disabled>
                            <input type="hidden" class="form-control" name="habilitacion" id="habilitacion" >
                          </div>
                          ...
                          <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            ...
                            <input type="number" class="form-control" name="precioUnitario" id="precioUnitario"  placeholder="Precio Unitario">
                          </div>
                          ...
                          <div class="form-group col-lg-3 col-md-3 col-sm-3 col-xs-12">
                            ...
                            <select  name="TerminoPago_idTerminoPago" id="TerminoPago_idTerminoPago" class="form-control selectpicker" required=""></select>
                          </div>

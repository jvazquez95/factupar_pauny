              ...
              <div class="col-md-12">
                  <div class="box">
                    ...
                    <div class="box-header with-border">
                          <h1 class="box-title">Hechauka - Ventas</h1>
                    ...
                    <div class="panel-body table-responsive" id="listadoregistros">
                            ...
                            <thead>
                              <th>1</th>
                              <th><?php $month = date('m')-1; $year = date('Y'); $day = date("d", mktime(0,0,0, $month-1, 0, $year)); echo date('Ym', mktime(0,0,0, $month, $day, $year)); ?></th>
                              <th>1</th>
                              <th>921</th>
                              <th>221</th>
                              <th>80028600</th>
                              <th>6</th>
                              <th>FULL OFFICE S.R.L</th>
                              <th>3521097</th>
                              <th>4</th>
                              <th>BLAS CORREA</th>
                              <th>999</th>
...
<script type="text/javascript" src="scripts/hechaukaVentas.js"></script>
<?php 
}
ob_end_flush();
?>
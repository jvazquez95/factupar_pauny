              ...
              <div class="col-md-12">
                  <div class="box">
                    <div class="box-header with-border">
                          <h1 class="box-title">Recepcion de mercaderias </h1>
                    </div>

                    <!-- /.box-header -->
                    <!-- centro -->
                  <div id="cabecera">
	                <p class="text-monospace">A Recibir - Terminados</p>

                    <div class="panel-body table-responsive" id="listadoregistrosTerminados">
                        <table id="tbllistadoTerminados" class="table table-striped table-bordered table-condensed table-hover">
                          <thead>
                            <th>Opciones</th>
                            <th>Orden #</th>
                            <th>Fecha</th>
...
<!-- 	                    <div class="panel-body table-responsive" id="listadoregistrosfacturados">
	                   	 <p class="text-monospace">Recibidos</p>

	                        <table id="tbllistadoRecibidos" class="table table-striped table-bordered table-condensed table-hover">
	                          <thead>
	                            <th>Opciones</th>
                              <th>Orden #</th>
	                            <th>Nro Compra</th>
                    ...
                    <button class="btn btn-success" id="btngenerarOrdenCompra" onclick="crud('articulo')"><i class="fa fa-caret-square-o-left"></i> Crear Nuevo Articulo</button>
					       ...
					       <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
					       	    ...
					       	    <div class="form-group col-lg-2 col-md-2 col-sm-2 col-xs-12">
                                    <label>Nro Factura Compra(*):</label>
                            		<input type="text" class="form-control" name="nroFacturaCompra" id="nroFacturaCompra" placeholder="Numero de factura">
                             	</div>
                                ...
                                <div id="guardarRecepcion">
		                                <button class="btn btn-success" id="btngenerarOrdenCompra" onclick="confirmarRecepcion()"><i class="fa fa-caret-square-o-left"></i> Finalizar recepcion de mercaderias</button>
                                </div>
        
                                <div id="actualizarRecepcion">
	                                <button class="btn btn-success" id="btngenerarOrdenCompra" onclick="confirmarRecepcionRecibido()"><i class="fa fa-caret-square-o-left"></i> Finalizar y actualizar recepcion de mercaderias</button>                
                                </div>
                    ...
                    <div class="panel-body table-responsive" id="listadoregistros">
                        <table id="tbllistadoDetalle" class="display compact" style="width:100%">
                          <thead>
                            ...
                            <th>Codigo Sap</th>
                            <th>Cantidad Solicitada - Total</th>
                            <th>Cantidad Solicitada - Pendiente</th>
                            <th>Cantidad Recibida - Factura</th>
  ...
  <!-- Fin modal -->
                    ...
                    <div class="container">
                          ...
                          <div class="modal" id="modalHacerPedidoDetalleArticulo">
                            <div class="modal-dialog modal-lg modal-dialog-centered">
                                    <span>Agregar detalle a la Recepcion</span>
...
require 'footer.php';
?>
<script type="text/javascript" src="scripts/recepcionMercaderias.js"></script>

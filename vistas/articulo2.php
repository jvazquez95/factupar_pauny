                                          ...
                                          <div class="form-group">
                                                 <div class="col">
                                                  ...
                                                  <div class="form-group col-lg-2 col-md-2 col-sm-3 col-xs-12">
                                                    ...
                                                    <select id="Articulo_idArticulo_l" name="Articulo_idArticulo_;" class="form-control input-sm selectpicker" data-live-search="true" ></select>
                                                  </div>
                                                  ...
                                                  <div class="form-group col-lg-2 col-md-2 col-sm-3 col-xs-12">
                                                    ...
                                                    <select id="compra" name="compra" class="form-control input-sm selectpicker" data-live-search="true" > 
                                                      <option>SI</option>
                                                      <option>NO</option>
                                                    </select>
                                                  </div>
                                                  ...
                                                  <div class="form-group col-lg-2 col-md-2 col-sm-3 col-xs-12">
                                                    ...
                                                    <select id="venta" name="venta" class="form-control input-sm selectpicker" data-live-search="true" > 
                                                      <option>SI</option>
                                                      <option>NO</option>
                                                    </select>
                                                  </div>
...
<script type="text/javascript" src="scripts/articulo2.js"></script>

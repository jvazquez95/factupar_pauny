                    ...
                    <div class="panel-body" style="height: 400px;" id="formularioregistros">
                        <form name="formulario" id="formulario" method="POST">
                          ...
                          <div class="form-group col-lg-1 col-md-2 col-sm-6 col-xs-12">
                            ...
                            <input type="number" class="form-control" name="transaccionOrigen" id="transaccionOrigen" maxlength="12" placeholder="Transaccion Origen" required>
                          </div> 
                                        ...
                                        <div class="col-md-12">
                                          <div class="form-group">
                                            <div class="form-group col-lg-1 col-md-1 col-sm-1 col-xs-12">
                                              <label class=" input-sm">item:</label>
                                                <input type="number" class="form-control input-sm " name="item" id="item" maxlength="12" placeholder="" readonly>
                                            </div>
                                            <div class="form-group col-lg-2 col-md-1 col-sm-1 col-xs-12">
                                            ...
                                            <div class="form-group col-lg-2 col-md-1 col-sm-1 col-xs-12">
                                              <label class=" input-sm">Importe Debito:</label>
                                              <input type="number" class="form-control input-sm " name="importeDebito" id="importeDebito" maxlength="15" placeholder="Importe Debito">
                                            </div>
                                            <div class="form-group col-lg-2 col-md-1 col-sm-1 col-xs-12">
                                              <label class=" input-sm">Importe Credito:</label>
                                              <input type="number" class="form-control input-sm " name="importeCredito" id="importeCredito" maxlength="15" placeholder="Importe Credito">
                                            </div>      
                                            <div class="form-group col-lg-2 col-md-1 col-sm-1 col-xs-12">
                                            ...
                                            <div class="form-group col-lg-1 col-md-1 col-sm-1 col-xs-12" style="visibility: hidden">
                                              <label class=" input-sm">item:</label>
                                                <input type="text" class="form-control input-sm " name="item2" id="item2" maxlength="12" placeholder="">
                                            </div>     
                                            <div class="form-group col-lg-1 col-md-1 col-sm-1 col-xs-12">

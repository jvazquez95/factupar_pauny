              ...
              <div class="col-md-12">
                  <div class="box">
                    <div class="box-header with-border">
                          <h1 class="box-title">Analisis de compras - Gastos</h1>
...
require 'footer.php';
?>
<script type="text/javascript" src="scripts/autorizacionComprasGasto.js"></script>
<?php 
}
ob_end_flush();
?>

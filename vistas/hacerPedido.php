...
<!--Contenido-->
              ...
              <div class="col-md-12">
                  <div class="box">
                    <div class="box-header with-border">
                          <h1 class="box-title">Analisis de Pedido</h1>
                       ...
                       <div class="form-group col-lg-3 col-md-3 col-sm-6 col-xs-12">
                        ...
                        <div class="form-group col-lg-3 col-md-3 col-sm-6 col-xs-12">
                          ...
                          <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            ...
                            <button class="btn btn-success" onclick="mostrarProveedor()" type="button"><i class="fa fa-arrow-circle-left"></i> Nuevo Analisis de Pedido</button>
                          </div>
  ...
  <!--Fin-Contenido-->
                            ...
                            <div class="modal-dialog modal-lg modal-dialog-centered">
                              ...
                              <div class="modal-content">
                                ...
                                <div class="modal-body">
                                                  ...
                                                  <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                      <label class=" input-sm">Seleccione Sucursal:</label>
                                                        <select id="Sucursal_idSucursalD1" name="Sucursal_idSucursalD1" class="form-control input-sm selectpicker" data-live-search="true" ></select>
                                                    </div>


                                                    <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                      <label class=" input-sm">Cant de Dias:</label>
                                                      <input type="number" class="form-control input-sm" name="meses" id="meses" required>
                                                    </div>

                                                  <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                      <label class=" input-sm">Precio por:</label>
                                                        <select id="tipo" name="tipo" id="tipo" class="form-control input-sm selectpicker" data-live-search="true" >
                                                        	<option value="1">Por Sucursal</option>
                                                        	<option value="2">Por Grupo Cliente</option>
                                                        </select>
                                                    </div>
                    ...
                    <div class="container">
                          ...
                          <!-- The Modal -->
                          <div class="modal" id="editarNombre">
                            <div class="modal-dialog modal-lg modal-dialog-centered">
                                    <span>Editar</span>
                              ...
                              <div class="modal-content">
                                ...
                                <div class="modal-body">
                                  ...
                                  <form name="formularioArticulo" id="formularioArticulo" method="POST">
                                            <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                              <label>Nuevo nombre del Articulo:</label>
                                              <input type="hidden" name="idArticulo" id="idArticulo">

                                              <input type="text" class="form-control" name="nombreArticulo" id="nombreArticulo" maxlength="250" required>
                                            </div>


                                            <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                              <button class="btn btn-primary" type="submit" id="btnGuardarArticulo"><i class="fa fa-save"></i> Guardar</button>
                                            </div>
                                          </form>
...
require 'footer.php';
?>
<script type="text/javascript" src="scripts/hacerPedido.js"></script>

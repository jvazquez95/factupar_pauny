                    ...
                    <button class="btn btn-success btn-xs" id="btnagregar" onclick="crud('proveedorTimbrado');"><i class="fa fa-plus-circle"></i> Nuevo Timbrado por proveedor</button>
                        <form name="formulario" id="formulario" method="POST">
                                      ...
                                      <div class="form-group col-lg-2 col-md-2 col-sm-2 col-xs-12">
                                        ...
                                        <input type="hidden" class="form-control" name="Deposito_idDeposito" id="Deposito_idDeposito">
                                        ...
                                        <select   title="Selecciona Persona" onchange="listarTimbrado(this);" class="selectpicker selector_persona form-control person" data-style="btn-warning" name="Proveedor_idProveedor" id="Proveedor_idProveedor"  data-live-search="true"></select>
                                      </div>

              ...
              <div class="col-md-12">
                  <div class="box">
                    <div class="box-header with-border">
                          <h1 class="box-title">Compra <button class="btn btn-success" id="btnagregar" onclick="mostrarform(true)"><i class="fa fa-plus-circle"></i> Agregar</button><button class="btn btn-success" id="btnaticulo" onclick="crud('articulo')"><i class="fa fa-plus-circle"></i> Nuevo Articulo</button><button class="btn btn-success" id="btnaticulo" onclick="crud('centroDeCostos')"><i class="fa fa-plus-circle"></i> Nuevo Centro de Costos</button></h1>
                    ...
                    <button class="btn btn-success btn-xs" id="btnagregar" onclick="crud('proveedorTimbrado');"><i class="fa fa-plus-circle"></i> Nuevo Timbrado por proveedor</button>
                        <form name="formulario" id="formulario" method="POST">
                                      ...
                                      <div class="form-group col-lg-5 col-md-5 col-sm-5 col-xs-12">
                                       ...
                                       <select data-style="btn-primary" name="Deposito_idDeposito" id="Deposito_idDeposito" class="form-control selectpicker" data-live-search="true"></select>
                                      </div>
...
<!--                                       <div class="form-group col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                        <label>Seleccione OC:</label>
                                        <select data-style="btn-primary" onchange="cargarOC(this);" name="OrdenCompra_idOrdenCompra" id="OrdenCompra_idOrdenCompra" class="form-control selectpicker" data-live-search="true"></select>
                                      </div> -->
                                      ...
                                      <div class="form-group col-lg-2 col-md-2 col-sm-6 col-xs-12">
                                        ...
                                        <input onblur="comparar2();" type="text" id="total_cabecera" name="total_cabecera" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-lg">
                                      </div>

                                      <div class="form-group col-lg-1 col-md-1 col-sm-6 col-xs-12">
                                        <label>Diferencia:</label>
                                        <input type="number" id="diferencia" name="diferencia" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-lg" readonly>
                                      </div>
                                      ...
                                      <div class="form-group col-lg-2 col-md-2 col-sm-2 col-xs-12">
                                        ...
                                        <input type="hidden" class="form-control" name="Habilitacion_idHabilitacion" id="Habilitacion_idHabilitacion">
                                     	  <input type="hidden" class="form-control" name="HacerPedido_idHacerPedido" id="HacerPedido_idHacerPedido">
                                        ...
                                        <select   title="Selecciona Articulo" onchange="listarTimbrado(this);" class="selectpicker selector_persona form-control person" data-style="btn-warning" name="Proveedor_idProveedor" id="Proveedor_idProveedor"  data-live-search="true"></select>
                                      </div>
                                      ...
                                      <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                  <select   title="Selecciona Articulo" 
                                      ...
                                      <button type="button" class="btn btn-success btn-xs" id="btnagregar" onclick="crud('cheque');"><i class="fa fa-plus-circle"></i> Nuevo Cheque</button>
                                      </div>
...
<script type="text/javascript" src="scripts/compraDirecta.js"></script>
<?php 
}
ob_end_flush();
?>

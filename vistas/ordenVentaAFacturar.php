...
{
?>
<!--Contenido - fondo blanco para no invadir con azul -->
<div class="content-wrapper pagina-facturacion">
        <style type="text/css">
          .pagina-facturacion { background: #fff !important; }
          .pagina-facturacion .content { background: #fff !important; font-size: 100%; }
          .pagina-facturacion .box { background: #fff !important; border: 1px solid #e5e5e5; }
        </style>
              ...
              <div class="col-md-12">
                  <div class="box">
                    <div class="box-header with-border">
                          <h1 class="box-title">Venta y Facturacion. </h1>
                    ...
                    <p class="text-monospace">Pendientes de Facturacion<button class="btn btn-success"  id="btnimprimir" onclick="generarFactura();"><i class="fa fa-print"></i> Nueva Venta</button></p>
                    ...
                    <p class="text-monospace">Facturados</p>
                        ...
                        <form name="formulario" id="formulario" method="POST">
                          ...
                          <!-- <div class="form-group col-lg-3 col-md-3 col-sm-3 col-xs-12"> -->
                            <!-- <label>Usuario:</label> -->
                            <input type="hidden" class="form-control" name="usuario1" id="usuario1" value="<?php echo 'Usuario: ' .$_SESSION['login'].' Nombre completo: '.$_SESSION['nombre'] ?>" disabled>
                          <!-- </div> -->
                          ...
                          <div hidden class="form-group col-lg-1 col-md-2 col-sm-2 col-xs-12">
...
-->
                          <div hidden class="form-group col-lg-1 col-md-1 col-sm-1 col-xs-12">
                          ...
                          <div class="form-group col-lg-2 col-md-2 col-sm-2 col-xs-12">
                            <label>Moneda(*):</label>
                            <select name="Moneda_idMoneda" id="Moneda_idMoneda" onchange="cargarTasa(this); actualizarSimboloMoneda(); calcularTotales();" class="form-control selectpicker" data-live-search="true" required>
                            </select>
                          ...
                          <div class="col-lg-12 col-sm-12 col-md-12 col-xs-12 table-responsive">
                            <table id="detalles" class="table table-striped table-bordered table-condensed table-hover">
                              <thead style="background-color:#A9D0F5">
                                    ...
                                    <th>Impuesto</th>
                                    <th>Total Neto</th>
                                    <th>Subtotal <span id="simboloMonedaHeader">(Gs.)</span></th>
                                </thead>
                                <tfoot>
                                    <th></th>
                                    <th></th>
                      ...
                      <div id="pagoDetalle">
                          ...
                          <div class="form-group col-lg-3 col-md-3 col-sm-3 col-xs-12">
                            <label>Importe(*):</label>
                            <input type="text" class="form-control" name="importe_detalle" id="importe_detalle">
                          </div>
                    ...
                    <div class="col-lg-12 col-sm-12 col-md-12 col-xs-12 table-responsive">
                          ...
                          <div class="form-group col-lg-4 col-md-4 col-sm-4 col-xs-12">
                            <label>La venta total es: <span id="simboloMonedaLabel">(Gs.)</span></label>
...
</div><!-- /.content-wrapper.pagina-facturacion -->
  <!--Fin-Contenido-->
...
<script type="text/javascript" src="scripts/ordenVentaAFacturar.js"></script>
<?php 
}
ob_end_flush();
?>

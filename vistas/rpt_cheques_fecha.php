              ...
              <div class="col-md-12">
                  <div class="box">
                    ...
                    <div class="box-header with-border">
                          <h1 class="box-title">Lista de Cheques</h1>
                    ...
                    <div class="form-group col-lg-3 col-md-3 col-sm-3 col-xs-12">
                          ...
                          <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            ...
                            <select id="tipoCheque" name="tipoCheque" class="form-control selectpicker" data-live-search="true">
                          ...
                          <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            ...
                            <select id="tipoFecha" name="tipoFecha" class="form-control selectpicker" data-live-search="true">
                              <option value="1">Fecha de Emision</option>
                              <option value="2">Fecha de Cobro</option>
                            </select>
                          </div>
...
<script type="text/javascript" src="scripts/rpt_cheques_fecha.js"></script>
<?php 
}
ob_end_flush();
?>
              ...
              <div class="col-md-12">
                  <div class="box">
                    <div class="box-header with-border">
                          <h1 class="box-title">Cuentas a cobrar </h1>
...
<!--                               <select id="cliente" name="cliente" class="form-control selectpicker" data-live-search="true" required></select>
 -->
						...
						-->
                          ...
                          <input type="button" style="margin-left: 5px" class="btn btn-primary" name="generar" id="generar" onclick="generar();" value="Generar">
                          <input type="button" style="margin-left: 5px" class="btn btn-primary" name="generarRemision" id="generarRemision" onclick="generarRemision();" value="Generar Extracto Remision">
                        </div>        
...
<script type="text/javascript" src="scripts/cuentasACobrarPorCliente.js"></script>
<?php 
}
ob_end_flush(); 
?>

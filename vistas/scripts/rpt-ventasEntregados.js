        ...
        $(document).ready(function() {
            $('#tbllistado').DataTable( {
				"fnRowCallback": function( nRow, aaData, iDisplayIndex, iDisplayIndexFull ) {
				  if ( aaData[12] == '<span class="label bg-green">Entregado</span>' )
					  {
						$('td', nRow).css('background-color', '#F5F6AD' );
					  }
					},
                "aProcessing": true,//Activamos el procesamiento del datatables
                "aServerSide": true,//Paginación y filtrado realizados por el servidor
            ...
            "thousands": "."
                ...
                "ajax":
                        {
                            url: '../ajax/consultas.php?op=rptventasEntregados',
                            data:{f_i: f_i, f_f: f_f},
                            type : "get",
                            dataType : "json",                      
                            error: function(e){
...
function marcar(idVenta)
{

        	$.post("../ajax/consultas.php?op=marcarEntregado", {idVenta : idVenta}, function(e){
			swal({
			  position: 'top-end',
			  type: 'success',
			  title: e,

...
function generar(){
    ...
    var c_f = $("#c_f").val();    
        ...
        $(document).ready(function() {
            ...
            "thousands": "."
                ...
                "ajax":
                        {
                            url: '../ajax/consultas.php?op=GenerarMaestroSaldos',
                            data:{c_i: c_i, c_f: c_f},
                            type : "get",
                            dataType : "json",                      
                            error: function(e){
   ...
   // window.open("../reportes/rptAgrupacionContable.php?ci="+ $("#c_i").val()+"&cf="+ $("#c_f").val());
}
    ...
    var c_f = $("#c_f").val();    
        ...
        $(document).ready(function() {
            ...
            "thousands": "."
                ...
                "ajax":
                        {
                            url: '../ajax/consultas.php?op=maestroSaldos',
                            data:{c_i: c_i, c_f: c_f},
                            type : "get",
                            dataType : "json",                      
                            error: function(e){

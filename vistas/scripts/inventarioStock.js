...
function init(){
	...
	$.post("../ajax/inventarioStock.php?op=selectDeposito", function(r){ 
	...
	//Cargamos los items al select categoria
	$.post("../ajax/inventarioStock.php?op=selectArticulo", function(r){
...
function listar()
{
	tabla=$('#tbllistado').dataTable(
	{
		...
		"ajax":
				{
					url: '../ajax/inventarioStock.php?op=listar',
					type : "get",
					dataType : "json",						
					error: function(e){
...
function guardaryeditar(e)
{
	...
	$.ajax({
		url: "../ajax/inventarioStock.php?op=guardaryeditar",
	    type: "POST",
	    data: formData,
	    contentType: false,
	    processData: false,
...
{
	$.post("../ajax/inventarioStock.php?op=mostrar",{idAjusteStock : idAjusteStock}, function(data, status)
	{
	...
	$.post("../ajax/inventarioStock.php?op=listarDetalle&idAjusteStock="+idAjusteStock,function(r){
...
function addDetalleAjusteStock()
  ...
  function eliminarDetalleAjusteStock(indice,valor){
				...
				if (valor > 0) {
				        	...
				        	$.post("../ajax/inventarioStock.php?op=desactivarDetalle", {idAjusteStockDetalle : valor}, function(e){
				        	});
				}	
...
swal({
	  ...
	  if (result.value) {
        	$.post("../ajax/inventarioStock.php?op=desactivar", {idAjusteStock : idAjusteStock}, function(e){
			swal({
			  position: 'top-end',
			  type: 'success',
			  title: e,
...
swal({
	  ...
	  if (result.value) {
        	$.post("../ajax/inventarioStock.php?op=activar", {idAjusteStock : idAjusteStock}, function(e){
			swal({
			  position: 'top-end',
			  type: 'success',
			  title: e,

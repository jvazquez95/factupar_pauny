...
function actualizarCantidadCaja(x, idArticulo , Deposito_idDeposito, cantidadActual, contPrecio){
	...
	$.ajax({
    	type: "get",
    	url: '../ajax/inventarioAjusteApp.php?op=actualizarCantidadCaja',
...
function filtrar()
{
	...
	tabla=$('#tbllistado').dataTable(
	{
		...
		"ajax":
				{
					url: '../ajax/inventarioAjusteApp.php?op=listar',
					type : "get",
...
function mostrarDetalle(idAjusteStock)
{
	...
	tabla=$('#tbllistadoDetalle').dataTable(
	{
		...
		"ajax":
				{
					url: '../ajax/inventarioAjusteApp.php?op=mostrarDetalle',
					type : "get",
...
function generarPedido()
{
    ...
    $.ajax({
        url: "../ajax/inventarioAjusteApp.php?op=generarPedido",
        type: "GET",

...
function init(){
	...
	$.post("../ajax/movimientoStock.php?op=selectDepositoOrigen", function(r){
	...
	//Cargamos los items al select categoria
	$.post("../ajax/movimientoStock.php?op=selectDepositoDestino", function(r){
	...
	// //Cargamos los items al select categoria
	// $.post("../ajax/movimientoStock.php?op=selectArticulo", function(r){

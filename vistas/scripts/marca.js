...
function init(){
	...
	$.post("../ajax/marca.php?op=selectSucursal", function(r){
...
{
	swal({
		  title: 'Esta seguro de desactivar la marca',
		  text: "",
		  type: 'warning',
		  ...
		  if (result.value) {
				$.ajax({
	    type: "post",
	    url: '../ajax/marca.php?op=desactivar',
...
{
	swal({
		  title: 'Esta seguro de activar la marca?',
		  text: "",
		  type: 'warning',
		  showCancelButton: true,
		  confirmButtonColor: '#3085d6',

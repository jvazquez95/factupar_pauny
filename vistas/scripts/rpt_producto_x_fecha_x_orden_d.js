...
$.post("../ajax/consultas.php?op=selectArticulo", function(r){
        $("#idArticulo").html(r);
...
function listar()
{
	...
	var idEmpleado = 0;//$("#idConcepto").val();
	...
	tabla=$('#tbllistado').dataTable(
	{
		...
		"ajax":
				{
					url: '../ajax/consultas.php?op=rpt_producto_x_fecha_x_orden_d',
					data:{fi: fi, ff:ff, idEmpleado:idEmpleado, idArticulo:idArticulo},
					type : "get",
					dataType : "json",						
					error: function(e){

...
function generar(){
  var f_i = $("#f_i").val();
    ...
    var c_f = $("#c_f").val();    
        ...
        $(document).ready(function() {
            ...
            "thousands": "."
                ...
                "ajax":
                        {
                            url: '../ajax/consultas.php?op=GeneraBalance',
    ...
    window.open("../reportes/rptBalance.php?fi="+ $("#f_i").val()+"&ff="+ $("#f_f").val()+"&ci="+ $("#c_i").val()+"&cf="+ $("#c_f").val());
}
    ...
    var c_f = $("#c_f").val();    
        ...
        $(document).ready(function() {
            ...
            "thousands": "."
                ...
                "ajax":
                        {
                            url: '../ajax/consultas.php?op=balance',
                            data:{f_i: f_i, f_f: f_f,c_i: c_i, c_f: c_f},
                            type : "get",
                            dataType : "json",                      
                            error: function(e){

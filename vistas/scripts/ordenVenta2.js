...
function agregarDetalle(idarticulo,articulo,precioVenta,impuesto, capital, interes)
  {
  	var cantidad=1;
    var descuento=0;
	var precioVentan;
    ...
    if (idarticulo!="")
    {
    	...
    	'<td><input type="hidden" name="precioVenta[]" onblur="modificarSubototales()"  id="precioVenta[]" value="'+precioVenta+'">'+precioVenta+'</td>'+
    	'<td><input type="number" name="descuento[]" id="descuento[]" onblur="modificarSubototales()"  value="'+descuento+'"></td>'+

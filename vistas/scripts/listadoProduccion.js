...
function init(){
	...
	//cargamos los items al select usuario
	$.post("../ajax/articulo.php?op=selectArticulosTodos", function(r){
...
function filtrar()
{
	...
	tabla=$('#tbllistado').dataTable(
	{
		...
		"ajax":
				{
					url: '../ajax/listadoProduccion.php?op=listar',
					type : "get",
					data : { Deposito_idDeposito:Deposito_idDeposito, fi:fi,ff:ff, estado:estado, Categoria_idCategoria:Categoria_idCategoria },
					dataType : "json",						
					error: function(e){

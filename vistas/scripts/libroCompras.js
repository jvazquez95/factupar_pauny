    ...
    var f_f = $("#f_f").val();
        ...
        $(document).ready(function() {
            ...
            "thousands": "."
                ...
                "ajax":
                        {
                            url: '../ajax/consultas.php?op=libroCompras',
                            data:{f_i: f_i, f_f: f_f},
                            type : "get",
                            dataType : "json",                      
                            error: function(e){
				...
				"footerCallback": function ( row, data, start, end, display ) {
				  ...
				  // Total over this page
				   ...
				   montoTotal0 = api
					...
					$( api.column( 5 ).footer() ).html(
					   formatNumber.new(gr10.toFixed(0)) 
					);
				   ...
				   montoTotal01 = api
					...
					$( api.column( 6 ).footer() ).html(
					   formatNumber.new(gr5.toFixed(0)) 
					);
				   ...
				   montoTotal02 = api
					...
					// Update footer
					$( api.column( 7 ).footer() ).html(
					   formatNumber.new(iva10.toFixed(0)) 
					);
					...
					$( api.column( 8 ).footer() ).html(
					   formatNumber.new(iva5.toFixed(0)) 
					);
				  ...
				  montoTotal1 = api
					...
					cantidad = montoTotal1;	
		 
					// Update footer
					$( api.column( 10 ).footer() ).html(
					   formatNumber.new(cantidad.toFixed(0)) 
					);
					/*
					montoTotal1 = api
					...
					$( api.column( 12 ).footer() ).html(
					   formatNumber.new(cantidad.toFixed(2)) 
					);

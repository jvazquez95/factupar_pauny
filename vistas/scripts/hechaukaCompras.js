...
$(document).ready(function() {
    $('#tbllistado6').DataTable( {
        ...
        "ajax":
                {
                    url: '../ajax/consultas.php?op=hechaukaCompras',
            ...
            "thousands": "."
				...
				"footerCallback": function ( row, data, start, end, display ) {
				  ...
				  montoTotal1 = api
					...
					cantidad = montoTotal1/2;	
		 
					// Update footer
					$( api.column( 11 ).header() ).html(
					...
					// Update footer
					$( api.column( 12 ).header() ).html(
					   formatNumber.new(monto.toFixed(0)) 
					);

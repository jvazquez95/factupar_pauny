...
function listar()
{
	...
	tabla=$('#tbllistado').dataTable(
	{
		...
		"ajax":
				{
					url: '../ajax/inventarioAjuste.php?op=listarAutorizacion',
					type : "get",
...
function mostrarDetalleAjuste(idAjusteStock){
	$('#modal_detalle').modal('show');
	$("#detalle").val(idAjusteStock);
$(document).ready(function() {
    $('#tbllistado4').DataTable( {
		...
		"ajax":
				{
					url: '../ajax/consultas.php?op=rpt_ajuste_detalle',
...
function autorizarInventario(idAjusteStock){

	var idAjusteStock = idAjusteStock;
...
$.ajax({
    	type: "get",
    	url: '../ajax/inventarioAjuste.php?op=autorizarInventario',
    	data: {idAjusteStock:idAjusteStock},
		dataType:"json",

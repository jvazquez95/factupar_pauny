...
function guardaryeditar(e)
{
	...
	$.ajax({
		url: "../ajax/clase.php?op=guardaryeditar",
	    type: "POST",
	    data: formData,
	    contentType: false,
	    processData: false,
...
function desactivar(idClase)
{
	swal({
		  ...
		  if (result.value) {
				$.ajax({
	    type: "post",
	    url: '../ajax/clase.php?op=desactivar',
...
{
	$.post("../ajax/clase.php?op=mostrar",{idClase : idClase}, function(data, status)
	{

...
require("db.php");
$getImages = $conexion->prepare("SELECT * FROM mesaEntradaImagen;");
$trajoImagenes = $getImages->execute();

if (!$trajoImagenes) die("Hubo un error, por favor, contacta al administrador.index");
        ...
        <div class="container">
            ...
            <section id="MyImages" class="images-cards">
                ...
                <div class="row" id="my-images">
                    ...
                    <div class="col-xl-2 col-lg-2 col-md-3 col-sm-4 col-xs-12" data-id="<?= $image["idMesaEntradaImagen"] ?>">
                        <input type="hidden" name="photo-iohQc" value="test">
                        <div class="image-container">
                            <figure> 
                                <img src="images/<?= $image["imagen"] ?>" alt="Foto del usuario">
                                <figcaption> 

              ...
              <div class="col-md-12">
                  <div class="box">
                    <div class="box-header with-border">
                        <h1 class="box-title">Agrupacion de cuentas contables</h1>
                    ...
                    <div class="form-group col-lg-12 col-md-3 col-sm-3 col-xs-12">
                      <input type="button" class="btn btn-primary" name="actualizar" id="actualizar" onclick="listar();" value="Listar asientos del periodo"> 
					            <input type="button" style="margin-left: 5px" class="btn btn-primary" name="generar" id="generar" onclick="generar();" value="Generar periodo">					            				            
                    </div>                    
...
<script type="text/javascript" src="scripts/agrupacionCuentasContables.js"></script>
<?php 
}
ob_end_flush();
?>
              ...
              <div class="col-md-12">
                  <div class="box">
                    <div class="box-header with-border">
                          <h1 class="box-title">Nota Credito Venta <button class="btn btn-success" id="btnagregar" onclick="mostrarform(true)"><i class="fa fa-plus-circle"></i> Agregar</button><button class="btn btn-success" id="btnaticulo" onclick="crud('articulo')"><i class="fa fa-plus-circle"></i> Nuevo Articulo</button></h1>
                    ...
                    <button class="btn btn-success btn-xs" id="btnagregar" onclick="crud('proveedorTimbrado');"><i class="fa fa-plus-circle"></i> Nuevo Timbrado por proveedor</button>
                        <form name="formulario" id="formulario" method="POST">
                          			...
                          			<div class="form-group col-lg-1 col-md-1 col-sm-1 col-xs-12">
                            			<label>Nro. Hab.:</label>
            							<input type="text" class="form-control" name="Habilitacion_idHabilitacion" id="Habilitacion_idHabilitacion" readonly>
                                      </div>
                                    
                                      <div class="form-group col-lg-2 col-md-2 col-sm-2 col-xs-12">
                                        <label>Deposito.:</label>
            							<input type="text" class="form-control" name="Deposito_idDeposito" id="Deposito_idDeposito" readonly>
                                      </div>
                                      ...
                                      <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        ...
                                        <select data-style="btn-primary" onchange="cargarCompra(this);" name="Venta_idVenta" id="Venta_idVenta" class="form-control selectpicker" data-live-search="true"></select>
                                      </div>
                                      ...
                                      <div class="form-group col-lg-2 col-md-2 col-sm-2 col-xs-12">
                                        ...
                                        <input type="hidden" class="form-control" name="TerminoPago_idTerminoPago" id="TerminoPago_idTerminoPago" value="1">
                                        ...
                                        <input type="hidden" class="form-control" name="timbrado" id="timbrado" readonly>
                                        <input type="hidden" class="form-control" name="vtoTimbrado" id="vtoTimbrado" readonly>


                                     <!--   <select id="Persona_idPersona" name="Persona_idPersona" onchange="listarTimbrado(this);" class="form-control selectpicker" data-live-search="true" required>
                                        </select>   -->


                                        <select   title="Selecciona Cliente" onchange="listarTimbrado(this);noCambiar();" class="selectpicker selector_persona form-control" data-style="btn-warning" name="Persona_idPersona" id="Persona_idPersona"  data-live-search="true"></select>
...
<!--                                       <div class="form-group col-lg-2 col-md-2 col-sm-2 col-xs-12">
                                        ...
                                        <input type="number" class="form-control" name="timbrado" id="timbrado" readonly>
                                      </div>
                  
                                      <div class="form-group col-lg-2 col-md-4 col-sm-4 col-xs-12">
                                        <label>Vencimiento Timbrado(*):</label>
                                        <input type="date" class="form-control" name="vtoTimbrado" id="vtoTimbrado" readonly>
                                      </div> -->
                                      ...
                                      <div class="form-group col-lg-2 col-md-6 col-sm-6 col-xs-12">
                                        ...
                                        <select name="tipo_comprobante" id="tipo_comprobante" class="form-control selectpicker" required="" >
                                           <option selected value="2">Nota de Credito Venta</option>
                                        </select>
                                      </div>

                                      <div class="form-group col-lg-2 col-md-2 col-sm-2 col-xs-12">
                                        <label>Serie - Punto de Expedicion(*):</label>
                                      ...
                                      <div class="form-group col-lg-2 col-md-2 col-sm-2 col-xs-12">
                                        ...
                                        <input type="text" class="form-control" name="nroFactura" id="nroFactura" readonly>
                                      </div>
			                          ...
			                          <div class="form-group col-lg-1 col-md-2 col-sm-2 col-xs-12">
			                            ...
			                            <input type="text" class="form-control" name="tasaCambioBases" id="tasaCambioBases" readonly> 
                   					  ...
                   					  <div class="form-group col-lg-2 col-md-2 col-sm-2 col-xs-12">
   			                            <label>Imagen de Nota de Credito:</label>
...
<script type="text/javascript" src="scripts/notaCreditoVenta.js"></script>
<?php 
}
ob_end_flush();
?>

              ...
              <div class="col-md-12">
                  <div class="box">
                    <div class="box-header with-border">
                          <h1 class="box-title">Movimientos de ingresos y egresos</h1>
                    ...
                    <div class="panel-body table-responsive" id="listadoregistros">
                        ...
                        <table id="tbllistado" class="table table-striped table-bordered table-condensed table-hover">
                          <thead>
                            ...
                            <th>Nro Hab.</th>
                            <th>Fecha</th>
                            <th>Cliente / Proveedor / Funcionario</th>
              							<th>Descripcion</th>
              							<th>Concepto</th>
              							<th>Usuario</th>
                            <th>Cantidad</th>
...
<script type="text/javascript" src="scripts/rpt-movimientos.js"></script>

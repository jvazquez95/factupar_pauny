<?php
	...
	class PDF extends PDF_ReporteBase
	{
		function Header()
		{
			...
			$this->Cell(180,1, "Libro Diario",0,1,'C');
			$this->Ln(5);
			...
			$this->Cell(10,6,'Linea',1,0,'C',1);
			$this->Cell(25,6,'Nro de Cuenta',1,0,'C',1);
			$this->Cell(37,6,'Cuenta Contable',1,0,'C',1);
			$this->Cell(37,6,'Comentario',1,0,'C',1);
			$this->Cell(27,6,'Importe Debito',1,0,'C',1);
			$this->Cell(27,6,'Importe Credito',1,1,'C',1);
		}
	}
?>

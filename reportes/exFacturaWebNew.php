...
$empresa = utf8_encode($reg0->nombre);
$propietario = 'Timbrado: ' .$reg0->timbrado;
$documento = "RUC: 80100378-4";
$direccion = utf8_encode($reg0->direccion);
...
$pdf->Cell(190,6,
  utf8_decode("Fecha :")  . date_format($date1, 'd-m-Y'), 1,0,'C');
...
$pdf->SetY(146);
$pdf->SetX(100);
$pdf->Cell(100,24,"\n\n TOTAL " .$formattedNum = number_format($reg->total)."Gs.", 1,0,'L');
...
$pdf->text(122,159,$formattedNum = number_format($exentas)."Gs.");

$pdf->text(150,159,$formattedNum = number_format($gc = $iva5/21)."Gs.");

$pdf->text(175,159,$formattedNum = number_format($gd = $iva10/11)."Gs.");

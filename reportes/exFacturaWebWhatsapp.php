...
$empresa = 'FULL OFFICE - '. utf8_encode($reg0->nombre);
...
while ($regd = $rsptad->fetchObject()) {
    ...
    $cantidad+=$regd->cantidad;
        ...
        /*IMPORTE*/
        $formattedNum = number_format($regd->precio);
        ...
        $pdf->MultiCell(28,5, $formattedNum = number_format($regd->precio*$regd->cantidad)."Gs.",0,"R" );
...
$pdf->text(175,150,$formattedNum = number_format($iva10)."Gs.");

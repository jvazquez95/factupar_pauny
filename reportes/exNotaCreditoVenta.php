...
$l_idVenta = $reg->idNotaCreditoVenta;
$empresa = '';
$propietario = '';
$documento = "";
$direccion = '';
...
// Parámetros: string $data:  Fecha en formato dd/mm/aaaa o timestamp//  int    $tipus: Tipo de fecha (0-timestamp, 1-dd/mm/aaaa)//// Retorna:    string  Fecha en formato largo (x, dd mm de yyyy)
...
//WHILE
$rsptad = $venta->ventadetalleNC($l_idVenta);
$cantidad=0;
$exentas=0;
$iva5=0;
$iva10=0;
